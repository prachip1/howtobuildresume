...
import { Upload, FileText, ArrowRight, Mail, CheckCircle2, BookOpen, Sparkles, Target, Award, GraduationCap, AlertTriangle, Bot } from 'lucide-react'
...
const faqLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'How do I build a resume from scratch?', acceptedAnswer: { '@type': 'Answer', text: 'Click "Start Blank" on the homepage. Our guided step-by-step process walks you through personal info, work experience, education, and skills. Smart questions help you write strong bullet points. You get an ATS-ready resume at the end — free.' } },
    { '@type': 'Question', name: 'Can I convert my LinkedIn profile to a resume?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Click "Paste LinkedIn," copy your LinkedIn profile text, and paste it in. We structure it into a clean, ATS-ready resume in minutes. Free.' } },
    { '@type': 'Question', name: 'What is an ATS resume?', acceptedAnswer: { '@type': 'Answer', text: 'An ATS (Applicant Tracking System) resume is formatted so software used by employers can read and rank it. howtobuildresume generates clean, ATS-friendly formatting by default — no tables, columns, or images that break parsing.' } },
    { '@type': 'Question', name: 'Can I upload my existing resume and improve it?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Upload your PDF or Word resume and we\'ll ask smart questions to improve your content, structure, and ATS-readiness. You can then edit and export as PDF.' } },
    { '@type': 'Question', name: 'How long does it take to build a resume?', acceptedAnswer: { '@type': 'Answer', text: 'Most users finish in 10–20 minutes. If you upload an existing resume or paste LinkedIn, it\'s even faster — we pre-fill your information automatically.' } },
  ],
}

export default function Home({ searchParams }) {
  const fromMor = searchParams?.from === 'mor'
  return (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            {fromMor ? (
              <>
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black mb-6 leading-tight">
                  Build a Resume — No Signup
                </h1>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
                  Pick a path below — upload, paste LinkedIn, or start blank. Download the PDF, then bring it back to MOR to tailor it to a job.
                </p>
                <a
                  href="https://www.makersofresume.com"
            ...
            <p className="flex items-center justify-center gap-1.5 mt-5 text-xs text-gray-400">
              ...
              AI-powered · content is generated by AI — always review and edit before sending your resume out.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <Link
                href="/upload"
                className="group relative bg-white rounded-2xl p-7 shadow-key hover:shadow-key-md border-2 border-black transition-all duration-300 hover:-translate-y-1 overflow-hidden flex flex-col"
              >
                <div className="card-hover-grain" aria-hidden />
                <div className="relative z-10 flex flex-col flex-1">
                  <div className="w-12 h-12 rounded-xl bg-white border-2 border-black flex items-center justify-center mb-5 shadow-key-sm">
                    <Upload className="w-5 h-5 text-black" />
                  </div>
                  <h3 className="font-bold text-black text-lg mb-2">Upload Resume</h3>
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-xl bg-ref-green text-black border-2 border-black shadow-key px-4 py-2 font-medium text-sm group-hover:shadow-key-md transition-all self-start">
              ...
              <Link
                href="/linkedin"
                className="group relative bg-white rounded-2xl p-7 border-2 border-black transition-all duration-300 hover:-translate-y-1 shadow-key hover:shadow-key-md overflow-hidden flex flex-col"
              >
                <div className="card-hover-grain" aria-hidden />
                <div className="relative z-10 flex flex-col flex-1">
                  <div className="w-12 h-12 rounded-xl bg-white border-2 border-black flex items-center justify-center mb-5 shadow-key-sm">
                    <GrLinkedin className="w-5 h-5 text-black" />
                  </div>
                  <h3 className="font-bold text-black text-lg mb-2">Paste LinkedIn</h3>
                  <p className="text-sm text-gray-500 leading-relaxed flex-1 mb-6">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col flex-1">
                  ...
                  <h3 className="font-bold text-black text-lg mb-2">Start Blank</h3>
                  <p className="text-sm text-gray-500 leading-relaxed flex-1 mb-6">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-ref-green border border-black text-black shrink-0">New</span>
                  </div>
                  <p className="text-sm text-gray-500 leading-relaxed flex-1 mb-6">
            ...
            {/* AI disclaimer — below cards */}
            <div className="mt-6 flex items-start gap-3 px-5 py-4 bg-white border-2 border-gray-200 rounded-2xl">
              <AlertTriangle className="w-4 h-4 text-gray-400 shrink-0 mt-0.5" />
              <p className="text-sm text-gray-500 leading-relaxed">
                <span className="font-semibold text-gray-700">AI writes the draft — you own the final copy.</span>{' '}
                Our AI can get things wrong: dates, job titles, numbers, phrasing. Treat everything it produces as a starting point. Read through it, fix what&apos;s off, and make it yours before downloading or sending.
              </p>
            </div>
          </div>
          ...
          <section className="mt-24 mb-24">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { step: '3', title: 'Review & fix', desc: 'AI drafts it — you check for errors, refine the wording, and tailor it to the job.', icon: FileText },
            ...
            <div className="bg-white rounded-2xl border-2 border-black shadow-key p-8 sm:p-10">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  'AI-honest — the AI drafts, you decide. It can make mistakes, so always read and edit before submitting.',
                ].map((line, i) => (
            ...
            <section className="text-center pb-8">
              <div className="bg-white rounded-2xl border-2 border-black shadow-key p-8 sm:p-10 max-w-2xl mx-auto">
                <h2 className="text-xl sm:text-2xl font-bold text-black mb-2">
                  Done building? Take it back to MOR.
                </h2>
                <p className="text-gray-600 mb-6">
                  Once you download your PDF, head back to MOR and tailor it to any job description.
                </p>
                <a
                ...
                >
                  Back to MOR <ArrowRight className="w-4 h-4" />
                </a>
                <p className="flex items-center justify-center gap-1.5 mt-5 text-xs text-gray-400">
                  <Bot className="w-3.5 h-3.5 shrink-0" />
                  AI-generated content · review everything carefully before you send your resume to employers.
                </p>
              </div>
            </section>
          ) : (
